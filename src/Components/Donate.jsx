...
export default function Donate() {
  return (
    ...
    <div className="text-5xl font-bold p-5">Support Our Rescue Efforts</div>
    <h2 className='font-semibold text-xl my-5'>Your donation can make a difference!</h2>
    ...
    <div className=" bg-blue-400 border-2 border-black hover:bg-green-500 cursor-pointer self-center text-center my-10 font-semibold p-2 rounded-lg text-black w-40">
         Donate
        </div>
